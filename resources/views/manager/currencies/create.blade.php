...
@section('content')
    <div class="max-w-4xl mx-auto">
                        ...
                        @forelse ($currencies as $currency)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('manager.currencies.edit', $currency->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                    <form action="{{ route('manager.currencies.destroy', $currency->id) }}" method="POST" class="inline-block ml-4" onsubmit="return confirm('Are you sure you want to delete this currency? This action cannot be undone.');">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <form method="POST" action="{{ route('manager.currencies.store') }}">
                @csrf
                <div class="space-y-6">
                    <div>
