...
@section('meta_description', 'Admin dashboard with full system overview.')
...
@section('content')
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- New Transaction -->
            <a href="{{ route('admin.transactions.create') }}" class="group block p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <!-- Manage Users -->
            <a href="{{ route('admin.users.index') }}" class="group block p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">Add, edit, or remove staff</p>
                    </div>
                </div>
            </a>

            <!-- Manage Rates -->
            <a href="{{ route('admin.rates.index') }}" class="group block p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div class="flex items-center">
            ...
            <a href="{{ route('opening-balances.index') }}" class="group block p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div class="flex items-center">
                    <div class="flex-shrink-0 h-12 w-12 rounded-full bg-orange-100 flex items-center justify-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-semibold text-gray-900 group-hover:text-orange-600 transition-colors">Opening Balances</h3>
                        <p class="text-sm text-gray-500">View & manage daily balances</p>
                    </div>
                </div>
            </a>
        </div>
                        ...
                        @forelse($managers as $manager)
                            <li class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                                    <span class="text-blue-600 font-medium">{{ substr($manager->name, 0, 1) }}</span>
                                </div>
                                <div class="ml-3">
                                ...
                                <div class="ml-auto">
                                    <span class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">Manager</span>
                                </div>
                            </li>
                        @empty
                    ...
                    <ul class="space-y-3">
                        @forelse($cashiers as $cashier)
                            <li class="flex items-center">
                                ...
                                <div class="ml-auto">
                                    <span class="px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">Cashier</span>
                                </div>
                            </li>
                        @empty
            ...
            <div class="divide-y divide-gray-200">
                ...
                <div class="px-6 pt-2">
                    <div class="flex border-b border-gray-200">
                        <button class="py-2 px-4 font-medium text-sm border-b-2 border-blue-500 text-blue-600 focus:outline-none">
                            Transactions
                        </button>
                        <button class="py-2 px-4 font-medium text-sm text-gray-500 hover:text-gray-700 focus:outline-none">
                            Deposits
                        </button>
                        <button class="py-2 px-4 font-medium text-sm text-gray-500 hover:text-gray-700 focus:outline-none">
                            Activities
                                ...
                                <div class="ml-3 flex-1">
                                    <div class="flex items-center justify-between">
                                        <p class="text-sm font-medium text-gray-900">
                                            {{ $transaction->user->name ?? 'System' }} - {{ ucfirst($transaction->type) }}
                                        </p>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        ...
                                        <span class="text-gray-400">Ref: {{ substr($transaction->id, 0, 8) }}</span>
                                    </p>
                                </div>
                            </div>
                        @empty
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex space-x-2">
                    <button class="px-3 py-1 text-xs bg-blue-100 text-blue-800 rounded-full">Weekly</button>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-semibold text-gray-800">Recent Cash Deposits</h3>
                    <a href="#" class="text-sm text-blue-500 hover:underline">View all</a>
                </div>
            </div>
            <div class="divide-y divide-gray-200">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    ...
                                    <span class="text-gray-400">Ref: {{ substr($deposit->id, 0, 8) }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
