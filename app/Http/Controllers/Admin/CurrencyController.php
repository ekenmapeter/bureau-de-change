...
class CurrencyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.rates.index')->with('success', 'Currency created successfully.');
    }
    ...
    public function update(Request $request, Currency $currency)
    {
        ...
        return redirect()->route('admin.rates.index')->with('success', 'Currency updated successfully.');
    }
    ...
    public function destroy(Currency $currency)
    {
        ...
        return redirect()->route('admin.rates.index')->with('success', 'Currency deleted successfully.');
    }
}
